...
},{"./transcoder-htmltable/transcoder-htmltable":2}],2:[function(require,module,exports){
(function (global){
/**
...
FusionCharts.register('module', ['private', 'HTMLTableDataHandler', function () {
    ...
    global.addDataHandler('HTMLTable', {
        ...
        decode: function (data, obj) {
             ...
             */
            global.raiseError(obj, '07101734', 'run', '::HTMLTableDataHandler.decode()', 'FusionCharts HTMLTable data-handler only supports decoding of data.');
